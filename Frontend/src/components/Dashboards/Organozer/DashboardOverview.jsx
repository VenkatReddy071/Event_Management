...
const DashboardOverview = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch summary: totalHostedEvents, totalParticipants, totalRevenue
        const summaryResponse = await axios.get(`${import.meta.env.VITE_SERVER_URL}/api/organizer/summary`, {
        ...
        // Fetch recent registrations (for display only)
