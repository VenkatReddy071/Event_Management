...
function Registration() {
  ...
  const fetchRegistrations=async()=>{
    try{
      const response=await axios.get(`${import.meta.env.VITE_SERVER_URL}/api/eventRegister/all`,{
  ...
  const handleDownload = () => {
    const header = ['Username', 'Email','Mobile', 'College Name', 'Year', 'Branch', 'Semester', 'Payment ID', 'Event', 'Sub-event'];
